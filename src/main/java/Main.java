...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        Shop shop1 = new Shop("Shop1", 40);
        Shop shop2 = new Shop("Shop2", 80);
        Book book5 = new Book("Book5","author5","123", 40);
        Book book6 = new Book("Book6","author6","123", 30);
        Book book7 = new Book("Book7","author7","123", 20);
